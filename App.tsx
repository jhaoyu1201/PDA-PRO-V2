...
const App: React.FC = () => {
  ...
  // Fix: Added missing handleImageUpload handler to manage file input changes
        ...
        <div className="flex-1 bg-[#020617] relative flex items-center justify-center overflow-hidden">
          {image ? (
            ...
            <div className="text-center p-12 bg-slate-900/50 rounded-3xl border border-slate-800 backdrop-blur-sm shadow-2xl">
              ...
              <label className="cursor-pointer px-10 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl transition-all shadow-xl inline-block active:scale-95 mt-4">
                選擇檔案
